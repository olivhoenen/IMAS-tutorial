...
We welcome any kind of contribution to `IMAS-tutorial`, 
from a simple comment, a question or even a full fledged pull 
request. 
Please first make sure you read and follow the 
[Code of Conduct](CODE_OF_CONDUCT.md).

## You think you found a bug in the tutorial, or have a question in its use
1. use the [issue search](https://github.com/iterorganization/IMAS-tutorial/issues)
...
its root cause (version of the IMAS-tutorial, OS and relevant 
